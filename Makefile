...
make: 
	$(CXX) $(CXXFLAGS) -c  main.cpp src/table.cpp  src/List/list_src/list.cpp src/List/list_src/dot.cpp src/List/list_src/dump.cpp
	$(CXX) $(CXXFLAGS) -o  a.exe main.o table.o list.o dot.o dump.o
	./a.exe
	rm *.o ./a.exe

clean:
	rm *.o ./a.exe src/List/logfiles/*.dot